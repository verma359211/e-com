...
export function FeaturesSectionDemo() {
	const features = [
		{
			title: "Steals of the Season!",
			description:
				"Grab your favorites at prices that will make your wallet happy!",
			skeleton: <SkeletonOne />,
			className:
				"col-span-1 lg:col-span-4 border-b lg:border-r dark:border-neutral-800",
		},
		{
			title: "Fresh Drops, Just for You!",
			description: "Be the first to own the trendiest styles of the season.",
			skeleton: <SkeletonTwo />,
			className: "border-b col-span-1 lg:col-span-2 dark:border-neutral-800",
		},
		{
			title: "Loved by All, Chosen by You!",
			description: "Shop the crowd’s favorite picks that never go out of style",
			skeleton: <SkeletonThree />,
			className:
				"col-span-1 lg:col-span-3 lg:border-r  dark:border-neutral-800",
		},
		{
			title: "Fast, Reliable, Anywhere!",
			description: "Bringing your favorites to your doorstep, right on time.",
		...
		<div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
			<div className="px-8">
				...
				<p className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
					Discover the best deals, the latest trends, and top-rated products—all
					with fast delivery straight to you. Shop now and enjoy an effortless
					shopping experience!
				</p>
			</div>
		...
		<div className="relative flex py-8 px-2 gap-10 h-full">
			<div className="w-full  p-5  mx-auto bg-white dark:bg-neutral-900 shadow-2xl group h-full">
				<div className="flex flex-1 w-full h-full flex-col space-y-2  ">
					{/* TODO */}
					<Image
						src="https://images.unsplash.com/photo-1532795986-dbef1643a596?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
						alt="header"
						width={800}
						height={800}
